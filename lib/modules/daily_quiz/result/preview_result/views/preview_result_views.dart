        ...
        child: Column(
          ...
          children: [
            QuestionExplanationSection(
              ...
              canRegenerate:
                  controller.explanationRegenerationAllowedByQuestionId[answer
                      .questionId] !=
                  false,
              isRegenerating:
                  controller.explanationRegeneratingByQuestionId[answer
                      .questionId] ==
                  true,
              onView: () => controller.fetchExplanation(type, answer),
              onAnother: () => controller.seeAnotherExplanation(type, answer),
              onRegenerate: (style) =>
                  controller.regenerateExplanation(type, answer, style),
              onClose: () => controller.closeExplanation(answer),
            ),
          ],
        ),
      );
