...
class _LearnEbookViewsState extends State<LearnEbookViews> {
  ...
  Widget build(BuildContext context) {
    final books = LearnEbookRepository.books.where((book) {
      final filterMatch =
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: LearnEbookRepository.filters.map((filter) {
...
class _MathBookPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final purple = Paint()..color = const Color(0xFFBA85D8).withValues(alpha: 0.8);
    canvas.drawCircle(Offset(size.width * 0.14, size.height * 0.55), 34, orange);
    canvas.drawCircle(Offset(size.width * 0.76, size.height * 0.45), 32, orange);
    canvas.drawCircle(Offset(size.width * 0.88, size.height * 0.66), 18, purple);

    final bookRect = RRect.fromRectAndRadius(
      Rect.fromLTWH(size.width * 0.24, size.height * 0.16, size.width * 0.48, size.height * 0.66),
      const Radius.circular(12),
    );
    canvas.drawRRect(bookRect, orange);
    canvas.drawRect(
      Rect.fromLTWH(size.width * 0.275, size.height * 0.16, 6, size.height * 0.66),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(size.width * 0.16, size.height * 0.1, size.width * 0.68, size.height * 0.78),
    ...
    final atom = Paint()
      ...
      ..strokeWidth = 1.5;
    canvas.drawOval(Rect.fromCenter(center: Offset(size.width * 0.57, size.height * 0.28), width: 70, height: 28), atom);
    canvas.drawOval(Rect.fromCenter(center: Offset(size.width * 0.57, size.height * 0.28), width: 30, height: 72), atom);
  }
...
class _HistoryBookPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(size.width * 0.18, size.height * 0.18, size.width * 0.48, size.height * 0.52),
        const Radius.circular(8),
      ),
      Paint()..color = const Color(0xFF1E8A8E),
    );
    canvas.drawRect(
      Rect.fromLTWH(size.width * 0.28, size.height * 0.28, size.width * 0.26, size.height * 0.12),
...
class _EnglishBookPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path()
      ...
      ..quadraticBezierTo(size.width * 0.62, size.height * 0.38, size.width * 0.5, size.height * 0.78)
      ..quadraticBezierTo(size.width * 0.67, size.height * 0.46, size.width * 0.88, size.height * 0.08)
      ..close();
...
class _BiologyBookPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawOval(
      Rect.fromCenter(center: Offset(size.width * 0.38, size.height * 0.58), width: 58, height: 24),
