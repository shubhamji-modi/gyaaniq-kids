...
class LearnTopicViews extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final completedTopics = chapter.topics
        .where((topic) => topic.status == LearnTopicStatus.completed)
        .length;
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: Text(
                                '${chapter.progressPercentage} Completed',
...
class _TopicCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isCompleted = topic.status == LearnTopicStatus.completed;
    final isInProgress = topic.status == LearnTopicStatus.inProgress;
    final isLocked = topic.status == LearnTopicStatus.locked;
